package com.rv.rahul.myapplication;
...
//                }
                ...
                Toast.makeText(getApplication().getApplicationContext(),"no of pic selected-->"+imagesPathList.size(),Toast.LENGTH_SHORT).show();
                Toast.makeText(getApplication().getApplicationContext(),"path-->"+imagesPathList.get(0),Toast.LENGTH_SHORT).show();
